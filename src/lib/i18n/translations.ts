...
const en = {
  ...
  location: {
    ...
    rows: [
      { customer: "HMMA", location: "Montgomery, Alabama", remark: "—" },
      { customer: "KaGA", location: "West Point, Georgia", remark: "Time zone (CT/ET)" },
      { customer: "Mercedes-Benz", location: "Vance, Alabama", remark: "—" },
      { customer: "Honda", location: "Lincoln, Alabama", remark: "—" },
      {
        customer: "Mazda Toyota Manufacturing",
        location: "Huntsville, Alabama",
        remark: "—",
      },
      { customer: "Volkswagen", location: "Chattanooga, Tennessee", remark: "Time zone (CT/ET)" },
      { customer: "Nissan", location: "Smyrna, Tennessee", remark: "Time zone (CT/ET)" },
      { customer: "General Motors", location: "Spring Hill, Tennessee", remark: "Time zone (CT/ET)" },
      { customer: "HMGMA", location: "Savannah, Georgia", remark: "—" },
    ],
  },
  services: {
...
const ko: Translations = {
  ...
  location: {
    ...
    rows: [
      { customer: "HMMA", location: "Montgomery, Alabama", remark: "—" },
      { customer: "KaGA", location: "West Point, Georgia", remark: "시간대 (CT/ET)" },
      { customer: "Mercedes-Benz", location: "Vance, Alabama", remark: "—" },
      { customer: "Honda", location: "Lincoln, Alabama", remark: "—" },
      {
        customer: "Mazda Toyota Manufacturing",
      ...
      { customer: "Volkswagen", location: "Chattanooga, Tennessee", remark: "시간대 (CT/ET)" },
      { customer: "Nissan", location: "Smyrna, Tennessee", remark: "시간대 (CT/ET)" },
      { customer: "General Motors", location: "Spring Hill, Tennessee", remark: "시간대 (CT/ET)" },
      { customer: "HMGMA", location: "Savannah, Georgia", remark: "—" },
    ],
  },
  services: {
